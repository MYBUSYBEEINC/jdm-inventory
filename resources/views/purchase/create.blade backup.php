                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Price Minimum</th>
                                        <th>Price Maximum</th>
                                        <th style="text-align: center"><a href="#""><i class="fas fa-plus-circle"></i></a></th>
                                    </tr>
                                </thead>
                                <tbody>
...
<script type="text/javascript">
    ...
    function addRow($curr_count){
        var tr = '<tr>'+
                        '<td>'+
                            '<select data-count="'+$curr_count+'" style="height:20%" name="product_name'+$curr_count+'" id="product_name'+$curr_count+'" class="form-control product_name {{$errors->has('unit_id') ? 'is-invalid' : ''}}">'+
                                '<option disabled selected value> -- select an option -- </option>'+
                        ...
                        '<td><input type="number" class="form-control price_min" id="price_min'+$curr_count+'" name="price_min'+$curr_count+'" readonly></td>'+
                        '<td><input type="number" class="form-control price_max" id="price_max'+$curr_count+'" name="price_max'+$curr_count+'" readonly></td>'+
